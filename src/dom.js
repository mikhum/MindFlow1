...
export function initDomElements() {
    ...
    domElements = {
        ...
        visibleDepthInput: document.getElementById("visible-depth-input"),
        toolbarVisibleDepthInput: document.getElementById("toolbar-visible-depth-input"),
        visibleDepthClear: document.getElementById("visible-depth-clear"),
        visibleDepthStatus: document.getElementById("visible-depth-status"),
        visibleDepthBadge: document.getElementById("visible-depth-badge"),
        visibleDepthQuickButtons: Array.from(document.querySelectorAll(".visible-depth-quick-btn")),
